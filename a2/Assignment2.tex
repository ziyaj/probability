...
\\
Let Y denote the number of tosses needed to obtain 3 heads. \( Y \sim NegBin(3, p) \). \\
...
Let Y denote the number of trials until the first head is obtained. \( Y \sim Geom(p) \).\\
